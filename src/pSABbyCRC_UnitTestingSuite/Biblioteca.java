...
public class Biblioteca {
	...
	public Biblioteca(String nome) {
		...
		_usuariosBiblioteca = new HashSet<Usuario>();
	}
	...
	public Usuario buscaUsuarioPorNome(String nome)
		...
		if ((nome != null)) {
			if (!nome.isEmpty()) {
				Iterator<Usuario> iter = _usuariosBiblioteca.iterator();
