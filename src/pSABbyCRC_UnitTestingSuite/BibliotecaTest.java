...
public class BibliotecaTest {
	...
	@Test
	public void whenEmprestoUmLivroAUsuarioEntaoLivroFicaIndisponívelParaEmprestimo()
			throws LivroIndisponivelParaEmprestimoException, LivroOuUsuarioNulosException { 
		// T13: Empresta um livro: Livro "Clojure––Sally Fields" para Usuario "José");
		biblioteca.emprestaLivro(livro2, usuario1);
		assertEquals(usuario1, livro2.getUsuario());
		
		// T14: Empresta outro livro: Livro "Using CRC Cards––Nancy Wilkinson" para Usuario "João");
		biblioteca.emprestaLivro(livro3, usuario2);
		assertEquals(usuario2, livro3.getUsuario());
	}
	
	@Test
	public void whenDevolvoUmLivroAUsuarioEntaoLivroFicaDisponívelParaEmprestimo()
			throws LivroIndisponivelParaEmprestimoException, LivroOuUsuarioNulosException,
	...
	@Test
	public void whenEmprestoTresLivrosAUmUnicosuarioEntaoListaLivrosdoUsuarioTemTam3()
			throws LivroIndisponivelParaEmprestimoException,LivroOuUsuarioNulosException { 
	...
	public void whenEmprestoLivroJahEmprestadoEntaoLivroDisponivelParaEmprestimoExceptionEhLancada()
			throws LivroIndisponivelParaEmprestimoException, LivroOuUsuarioNulosException { 
